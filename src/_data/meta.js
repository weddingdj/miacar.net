...
export const author = {
  name: 'Mia Car', // i.e. Lene Saile - page / blog author's name. Must be set.
  avatar: '/icon-512x512.png', // path to the author's avatar. In this case just using a favicon.
  email: 'contact@miacar.net', // i.e. hola@lenesaile.com - email of the author
  website: 'https://www.miacar.net', // i.e. https.://www.lenesaile.com - the personal site of the author
...
export const blog = {
  // RSS feed
  name: 'Mia Car Art + Music',
  description: 'Artworks by Mia Car.',
